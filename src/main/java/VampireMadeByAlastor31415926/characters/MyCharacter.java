package VampireMadeByAlastor31415926.characters;
...
public class MyCharacter extends CustomPlayer {
    ...
    public AbstractCard.CardColor getCardColor() {
        return PlayerColorEnum.COLOR_BLOOD;
    }
    ...
    public static class PlayerColorEnum {
        ...
        // ***并且名称需要一致！***
        @SpireEnum
        public static AbstractCard.CardColor COLOR_BLOOD;
    }
    ...
    public static class PlayerLibraryEnum {
        ...
        // 这个变量未被使用（呈现灰色）是正常的
        @SpireEnum
        public static CardLibrary.LibraryType COLOR_BLOOD;
    }
}
